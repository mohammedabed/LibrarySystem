...
{{--            <script src="{{ URL::to('/') }}/node_modules/bootstrap/dist/js/bootstrap.min.js" type="application/javascript"></script>
            <script src="{{ URL::to('/') }}/node_modules/jquery/dist/jquery.min.js" type="application/javascript"></script>--}}
