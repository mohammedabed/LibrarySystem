...
@section("content")
    <section class="content-header">
        <h1><i class="fa fa-pencil"></i> {{trans('greet.Edit Author')}}</h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-user"></i> Admin</a></li>
            <li class="">
                <a href="{{ url('/admin/author/list') }}">{{trans('greet.Author List')}}</a>
            </li>
            <li class="">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{trans('greet.Author Details')}}</h3>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="aBio">{{trans('greet.Short Bio')}}</label>
