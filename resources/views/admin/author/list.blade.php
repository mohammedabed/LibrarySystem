...
@section("content")
    <section class="content-header">
        <h1><i class="fa fa-book"></i> {{trans('greet.Authors')}} <small>{{trans('greet.Author List')}}</small></h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-user"></i> Admin</a></li>
            <li class="active">
                <a href="{{ url('author') }}">{{trans('greet.Authors')}}</a>
            </li>
        </ol>
    </section>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{trans('greet.Author List')}}</h3>
                        <p class='pull-right'>
                        <p class='pull-right'>
                            <a href="{{ url('/').'/admin/author/add-new' }}" class="btn btn-xs btn-info">
