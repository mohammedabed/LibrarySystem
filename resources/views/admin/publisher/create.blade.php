...
@section("content")
    <section class="content-header">
        <h1><i class="fa fa-plus"></i>    {{trans('greet.Add Publisher')}}  </h1>
        <ol class="breadcrumb">
            <li><a href="{{ url('/admin') }}"><i class="fa fa-user"></i> Admin</a></li>
            <li class="">
                <a href="{{ url('/admin/publisher/list') }}">   {{trans('greet. Publisher List')}} </a>
            </li>
            <li class="active">
                {{trans('greet.Add New')}}
            </li>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">   {{trans('greet.Publisher Details')}}  </h3>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-lg-10 col-md-10 col-sm-12">
                                    <div class="form-group">
                                        <label for="mName">   {{trans('greet.Name')}}  Name</label>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label id="" for="pEstablishYear">   {{trans('greet.Establish year')}}  </label>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-5 col-sm-12">
                                    <div class="form-group">
                                        <label for="aCountry">   {{trans('greet.Country')}}  </label>
                                        <div class="input-group">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label id="" for="pPhone">   {{trans('greet.Phone')}}  </label>
                                        <div class="input-group">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label id="" for="aEmail">   {{trans('greet.email')}}  </label>
                                        <div class="input-group">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label id="" for="aWebsite">   {{trans('greet.Website')}}  </label>
                                        <div class="input-group">
