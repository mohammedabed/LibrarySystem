...
<header class="main-header">
    ...
    <a href="{{ URL::to('/admin') }}" class="logo">
        ...
        <span class="logo-lg"><b>{{ $common['app'] }}</b> </span>
    </a>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ URL::to('/') }}/my-profile"
                                   class="btn btn-default btn-flat">{{trans('greet.Profile')}}</a>
                            </div>
                            <div class="pull-left">
                                <a href="{{ URL::to('/') }}/change-password"
                                   class="btn btn-default btn-flat">{{trans('greet.chpass')}}</a>
                            </div>
                            <div class="pull-right">
                                <a href="{{ URL::to('/') }}/auth/logout"
                                   class="btn btn-default btn-flat">{{trans('greet.Log out')}}</a>
                            </div>
                        </li>
                    </ul>
                </li>
