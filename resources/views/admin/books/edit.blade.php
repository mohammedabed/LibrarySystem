...
@section("content")
    <section class="content-header">
        <h1><i class="fa fa-pencil"></i> {{trans('greet.Edit Book')}}</h1>
        <ol class="breadcrumb">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-book"></i> {{trans('greet.Book Details')}}</h3>
                    </div>
...
{{--                                        {{ isset($book->authors()->get()[0]->name) ? $book->authors()->get()[0]->name : '' }}--}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="shelf">{{trans('greet.Shelf')}}</label>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label>{{trans('greet.Shelf Level')}}</label>
                            ...
                            <p class="">
                                <a class="pull-left text-warning" href="{{ url('/').'/admin/book/'.$book->id.'/delete' }}"
                                   title="Delete Book" data-toggle="tooltip">
                                    <i class="fa fa-trash"></i> {{trans('greet.Delete Book')}}</a>
                                <button class="pull-right btn btn-primary btn-flat" type="submit">{{trans('greet.Save')}}</button>
                            </p>
                        </div>
                    </form>
                </div>
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h4><i class="fa fa-copy"></i> {{trans('greet.Books Copy')}}Books Copy</h4>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 text-right">
                                <form action="{{ url('/').'/admin/book/'.$book->id.'/copy' }}" method="post">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <button type="submit" class="btn btn-default btn-sm btn-flat"><i class="fa fa-plus"></i> {{trans('greet.Category 3')}}Add New Copy</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form action="{{ url('/').'/admin/book/'.$book->id.'/copy/'.$copy->id }}"
                                        ...
                                        <td class="text-right">
                                            @if($copy->deleted_at == null)
                                                <button class="btn btn-sm btn-flat" type="submit">{{trans('greet.Update')}}</button>
                                            @else
