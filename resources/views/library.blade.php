...
<head>
    ...
    <title>@yield('title', "UCAS Library Management System")</title>
...
<script src="{{ URL::to('/') }}/public/assets/bootstrap.min.js" type="application/javascript"></script>
<script src="{{ URL::to('/') }}/public/assets/jquery-1.11.3.min.js" type="application/javascript"></script>
