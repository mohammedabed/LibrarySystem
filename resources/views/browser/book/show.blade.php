            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <section>
                    <table class="table">
                        ...
                        <tr>
                            <td><i class="fa fa-user"></i> {{trans('greet.Authors')}}</td>
                            <td>
                        ...
                        <tr>
                            <td><i class="fa fa-copy"></i> {{trans('greet.Copy code')}}</td>
                            <td>
                        ...
                        <tr>
                            <td><i class="fa fa-building-o"></i> {{trans('greet.Publisher')}}</td>
                            <td>
                                {{ $book->publisher->name }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <small class="text-muted">{{trans('greet.Published:')}}</small>{{ $book->publishDate->format('d M, Y') }}
                                <br/><br/>
                                <small class="text-muted">{{trans('greet.ISBN 10')}}:</small>{{ $book->isbn10 }}<br/>
                                <small class="text-muted">{{trans('greet.ISBN 13')}}:</small>{{ $book->isbn13 }}
                            </td>
                        </tr>
                        </tbody>
                    </table>
