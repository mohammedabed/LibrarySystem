<?php
    ...
    class BookController extends Controller
    {
        ...
        public function store(Request $request)
        {
          ...
          //  Storage::disk('local')->put($fileNameToStore,File::get('thumbnail'));
           // }else{
          ...
          //  }
            ...
            if ($validator->fails()) {
             ...
             //  $book->thumbnail=$fileNameToStore;
                $book->save();
              ...
              public function getimg($fileNameToStore)
              {
                  $file= Storage::disk('local')->get($fileNameToStore);
