...
class BorrowController extends Controller
{
    ...
    public function index()
    {
         ...
         * 4. any book can be borrowed for maximum 2 full weeks [dueDate].
         * 5. After dueDate , $2 fine for each day.
         */
        //  /*       *العضو العادي أقصى حد 6 كتب
        // * العضو أقل من 12 سنة 3 كتب
        // مدة الاستعارة أسبوعين
        // الغرمة 2شيكل عن كل يوم
        *
