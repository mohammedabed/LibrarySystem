<?php
    ...
    */
     ...
     * library.
     */
    Route::get('/', ['uses' => 'HomeController@create']);
Route::get('/about', ['uses' => 'HomeController@about']);
//Route::get('/', function () {
  //  return view('/');
//});
    Route::get('/list', ['uses' => 'HomeController@booklist']);
    ...
    Route::get('/bookimg/{fileNameToStore}',[
        'uses'=>'BookController@getimg', 'as'=>'book.img'
    ]);
    /**
     * Auth Routes
     */
